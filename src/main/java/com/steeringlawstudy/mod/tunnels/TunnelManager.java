...
public class TunnelManager {
    ...
    private static int currentTunnelIndex;
    ...
    public static void init(PlayerEntity p, World w) {
        ...
        // tunnel 2: 5 wide, corner, 5 high, angles: 6 blocks away, 10 blocks away
        BlockPos start_2 = new BlockPos(211, 81, 39);
        Tunnel tunnel_2 = new Tunnel(TunnelManager.getSegmentName(start_2), world);
        tunnel_2.playerStart = new BlockPos(209, 82, 33);

        tunnel_2.add(start_2, SegmentType.START);
        tunnel_2.add(new BlockPos(210, 81, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(209, 81, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(208, 81, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(207, 81, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 81, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 82, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 83, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 84, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 85, 39), SegmentType.PATH);
        tunnel_2.add(new BlockPos(206, 86, 39), SegmentType.STOP);
        list.put(tunnel_2.name, tunnel_2);

        // tunnel 3: 5 high, vertical, angles: 5 blocks away, 9 blocks away
        ...
        // tunnel 5: 4 wide hor., corner, 4 vertical, angles: 7 blocks away, 14 blocks away
        BlockPos start_5 = new BlockPos(272, 83, 61);
        Tunnel tunnel_5 = new Tunnel(TunnelManager.getSegmentName(start_5), world);
        tunnel_5.playerStart = new BlockPos(270, 80, 54);

        tunnel_5.add(start_5, SegmentType.START);
        tunnel_5.add(new BlockPos(271, 83, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(270, 83, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(269, 83, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(268, 83, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(268, 82, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(268, 81, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(268, 80, 61), SegmentType.PATH);
        tunnel_5.add(new BlockPos(268, 79, 61), SegmentType.STOP);
        ...
        tunnel_3.availableCameraAngles.add(new BlockPos(223, 66, 71));
        tunnel_5.availableCameraAngles.add(new BlockPos(270, 80, 47));
        tunnel_4.availableCameraAngles.add(new BlockPos(248, 81, 120));
        tunnel_2.availableCameraAngles.add(new BlockPos(209, 82, 29));
